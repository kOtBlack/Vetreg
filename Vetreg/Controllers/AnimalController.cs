...
namespace Vetreg.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GUID,AddDate,Sticker,ChipNumber,Birthday,Sex,Remark,IsRetired")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("GUID,AddDate,Sticker,ChipNumber,Birthday,Sex,Remark,IsRetired")] Animal animal)
        {
            if (id != animal.GUID)
            {
                return NotFound();
